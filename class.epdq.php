...
class WC_Ruman_EPDQ extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		add_action('woocommerce_api_wc_ruman_epdq', array(&$this, 'check_epdq_response'));
	}
	...
	public function admin_options() {
		...
		wp_enqueue_script('ruman_epdq_script',plugin_dir_url(__FILE__).'/script.js');
  	}
	...
	function receipt_page($order_id){
		...
		$order = new WC_Order( $order_id );
                ...
                $order_received_url = add_query_arg( 'wc-api', 'WC_Ruman_EPDQ', $order->get_checkout_order_received_url() );
        $fields = array(
        		...
        		'OWNERZIP'=>$order->get_billing_postcode(),
        		'OWNERADDRESS'=>$order->get_billing_address_1(),
        		'OWNERADDRESS2'=>$order->get_billing_address_2(),
        		'OWNERCTY'=>$woocommerce->countries->countries[$order->get_billing_country()],
        		'OWNERTOWN'=>$order->get_billing_city(),
	...
	function get_epdq_ncerror($code) {
		...
		$ncerorr_list=array(
			...
			31101001=>'Plafond transaction (major� du bonus) d�pass�.',
			31111001=>'Plafond mensuel (major� du bonus) d�pass�.',
			31121001=>'Plafond centre de facturation d�pass�.',
			31131001=>'Plafond entreprise d�pass�.',
			31141001=>'Code MCC du fournisseur non autoris� pour la carte.',
			31151001=>'Num�ro SIRET du fournisseur non autoris� pour la carte.',
			...
			34011001=>'Bezahlung mit RatePAY nicht m�glich.',
